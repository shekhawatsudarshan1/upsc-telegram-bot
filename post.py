...
SYLLABUS_CHECKLISTS = {
    "Polity Byte": [
        ...
        "Evolution of the Constitution - from Regulating Act 1773 to Independence Act 1947",
        ...
        "Doctrine of Basic Structure - Kesavananda Bharati case and evolution",
        # 2.1.2 Organs of State and Federal Dynamics
        ...
        "Parliament and State Assemblies - conduct of business and declining productivity",
        ...
        "Federalism - Seventh Schedule distribution of powers",
        "Asymmetric federalism",
        "Centre-State Relations - Legislative and Administrative",
        "Centre-State fiscal relations - GST disputes and Finance Commission",
        ...
        # 2.2.1 Institutional Frameworks and Accountability
        ...
        "NHRC and National Green Tribunal",
        "National Commissions - SC/ST/BC/Women/Minorities",
        "Citizens Charters and quality of service delivery",
        "Right to Information (RTI) framework",
        "Lokpal and Lokayuktas",
        "E-Governance - applications and models",
        "E-Governance - data privacy challenges",
        "Digital India initiatives",
        # 2.2.2 Civil Services and Civil Society
        "Civil services in a democracy - bureaucratic neutrality",
        "Lateral entry and civil service reforms",
        "Mission Karmayogi",
        "NGOs and Self Help Groups (SHGs)",
        "FCRA regulations and NGO funding issues",
        "Political parties and anti-defection",
        "Cooperative federalism and the GST Council",
    ],
    "History Byte": [
        # 1.2.1 Consolidation of British Rule
        ...
        "Decline of the Mughal Empire and rise of regional successor states",
        "Arrival of Europeans - Portuguese, Dutch, French, British",
        "Major battles - Plassey, Buxar, Anglo-Mysore, Anglo-Maratha wars",
        "British expansion tools - Subsidiary Alliance and Doctrine of Lapse",
        "Land revenue systems - Zamindari, Ryotwari, Mahalwari",
        "Economic impact of British rule - de-industrialization and Drain of Wealth",
        "Early tribal and peasant revolts - Santhal, Munda, Indigo rebellion",
        "1857 Revolt - causes and consequences",
        # 1.2.2 The Nationalist Movement and Various Strands
        "Formation of Indian National Congress",
        "Moderates vs Extremists in the INC - Surat Split",
        "Partition of Bengal and Swadeshi Movement",
        "Home Rule Movement",
        "Revolutionary activities - domestic and international",
        "Non-Cooperation Movement",
        "Civil Disobedience Movement",
        "Quit India Movement and constructive programmes",
        "Left-wing movements in the freedom struggle",
        "Subhas Chandra Bose and the INA",
        "Dalit movements - Dr. B.R. Ambedkar",
        "Communalism leading up to Partition",
        "Constitutional developments - Government of India Acts",
        "Partition of India and Independence",
        # 1.1.1 Ancient & Medieval Architecture
        "Indus Valley town planning, seals, and bronzes",
        "Buddhist and Jain architecture - Stupas, Chaityas, Viharas",
        "Temple architecture - Nagara, Dravida, and Vesara styles",
        "Regional temple styles - Nayak, Hoysala, Vijayanagara",
        "Indo-Islamic and Mughal architecture - arcuate style, Pietra dura",
        "Mughal art and culture",
        # 1.1.2 Indian Performing & Visual Arts
        "Classical dance forms - Bharatanatyam, Kathakali, Kathak, Odissi",
        "Folk dance traditions of India",
        "Schools of Indian painting - prehistoric rock art and murals (Ajanta, Ellora)",
        "Miniature painting schools - Pala, Mughal, Rajput, Pahari",
        "Indian classical music - Hindustani and Carnatic styles",
        "Musical instruments and folk music ecosystems",
        "Puppetry, theatre forms, and martial arts of India",
    ],
    "Geography Byte": [
        # 1.3.1 Physical Geography
        "Origin and evolution of the Earth",
        "Interior of the Earth and continental drift",
        "Plate tectonics theory and earthquakes/volcanism",
        ...
        "Atmospheric circulation, planetary winds, and jet streams",
        "Air masses and genesis of tropical/temperate cyclones",
        "Indian monsoon mechanism - El Nino, La Nina, IOD",
        "Climate classification of India and world (Koeppen)",
        "Natural vegetation and forest types",
        "Soil types of India",
        "Ocean relief, salinity distribution, and marine resources",
        "Ocean currents and tides",
        "Cyclones and their formation",
        "Earthquakes and volcanism mechanisms",
        # 1.3.2 Economic & Resource Geography
        "Distribution of natural resources - iron ore, coal, petroleum, rare earths",
        "Location factors for primary, secondary, tertiary industries",
        ...
        # 1.4.1 Core Features of Indian Society
        "Unity in Diversity - linguistic, religious, and ethnic pluralism",
        "Caste system - traditional structures and modern electoral politics",
        "The institution of family - joint family and nuclear shifts",
        # 1.4.2 Social Issues & Challenges
        "Role of women and women's organizations - gender wage gap, representation",
        "Urbanization challenges - slums, congestion, waste, flooding",
        "Smart city models",
        "Communalism, Regionalism, and Secularism - triggers and theory",
    ],
    "Economy Byte": [
        # 3.1.1 Macroeconomic Planning & Growth
        ...
        "Inclusive growth - financial inclusion (PMJDY)",
        "Jobless growth and regional inequalities",
        "Fiscal policy - Union Budget structure",
        "Fiscal deficit, revenue deficit, primary deficit",
        "FRBM Act and deficit financing",
        "Taxation - direct vs indirect tax structure",
        "GST - structure and implementation",
        "Monetary policy - RBI's role and tools",
        "Repo rate, reverse repo, CRR, SLR - inflation targeting",
        "Inflation - types and measurement (CPI, WPI)",
        "Banking sector - NPA management",
        ...
        # 3.1.2 Agricultural Economics & Supply Chain
        "Cropping patterns and irrigation systems",
        "Micro-irrigation technologies",
        "Farm subsidies - direct and indirect",
        "Minimum Support Price (MSP) debates",
        "WTO green/amber/blue boxes",
        "Agricultural marketing reforms - APMC and e-NAM",
        "Public Distribution System - objectives and leakages",
        "Buffer stock policies",
        "Food processing industries - forward and backward linkages",
        "Supply chain bottlenecks in agriculture",
    ...
    "Environment Byte": [
        ...
        # 3.3.1 Ecology and Climate Change
        "Environmental Impact Assessment (EIA) process and criticisms",
        ...
        "India's Panchamrit climate commitments and net-zero target",
        ...
        # 3.3.2 Disaster Risk Reduction
        "Disaster management frameworks - NDMA, SDMA",
        "Sendai Framework for Disaster Risk Reduction",
        "Cloudbursts and urban floods",
        "Landslides - Himalayas vs Western Ghats",
        "Cyclones and Glacial Lake Outburst Floods (GLOFs)",
    ],
    "Science & Tech Byte": [
        # 3.2.1 Indigenization & Emerging Technologies
        "Indigenous space missions - Gaganyaan, Chandrayaan, Aditya-L1",
        "Private space sector participation",
        "Satellite systems - GAGAN, NavIC",
        "Nuclear technology - civil nuclear programme",
        "Nuclear Suppliers Group and India's status",
        "Defence technology - IGMDP and missile systems",
        "Missile systems - Agni, Prithvi, BrahMos",
        "Defence technology - stealth tech and domestic manufacturing",
        "Artificial Intelligence, Machine Learning, and national strategy",
        ...
        # 3.2.2 Intellectual Property & Biotech
        "Intellectual Property Rights - patents and trademarks",
        "Geographical Indications (GIs) and India's IPR policy",
        "Biotechnology - GM crops and regulation (Bt Cotton, DMH-11)",
    ...
    "IR Byte": [
        # 2.3.1 India and its Neighborhood
        ...
        "India-Bhutan and India-Myanmar relations",
        "Cross-border challenges - String of Pearls strategy",
        "Border infrastructure development",
        "River water disputes - Indus, Teesta",
        "India and SAARC vs BIMSTEC",
        "India and BBIN",
        "India and ASEAN - Act East Policy",
        # 2.3.2 Global Geopolitics & Multilateralism
        "India and the Quad",
        "AUKUS and Indo-Pacific security architecture",
        "India and the Indo-Pacific strategy",
        "India-Africa relations",
        "India-Gulf/Middle East relations",
        "India-EU relations",
        "India and the United Nations - UNSC reform push",
        "India and the G20",
        "India and BRICS+",
        "India and the SCO and I2U2",
        "India and the WTO, IMF, and World Bank",
        ...
        # 3.4.1 Extremism & Asymmetric Warfare
        "Left-Wing Extremism - causes and Red Corridor",
        "Counter-insurgency operations - Samadhan doctrine",
        "Insurgency in the Northeast - ethnic conflicts",
        "Demands for Greater Nagalim and the AFSPA debate",
        "Organized crime and terrorism linkages - drug trafficking, hawala",
        "Golden Crescent and Golden Triangle - drug routes",
        # 3.4.2 Cyber Security & Border Management
        "Cyber threats - ransomware and critical infrastructure",
        "National Cyber Security Policy",
        "Coastal security and maritime domain awareness",
        "Fence technologies on porous borders",
    ],
    "Ethics & Motivation": [
        # 4.1.1 Essence, Determinants, and Consequences of Ethics
        "Ethics vs morality vs law",
        "Ethics in private and public relationships",
        "Lessons from great philosophers and reformers - Socrates, Kant, Gandhiji, Vivekananda",
        "Role of family, society, and education in inculcating moral values",
        "Determinants of ethics - values and conscience",
        "Aristotle's virtue ethics",
        "Kant's deontological ethics",
        "Utilitarianism - Bentham and Mill",
        "Gandhian ethics and Trusteeship",
        # 4.1.2 Attitude & Aptitude for Civil Services
        "Attitude - content, structure, function, and influence on behaviour",
        "Persuasion techniques and social influence",
        "Foundational values for Civil Services - integrity, impartiality, objectivity",
        "Foundational values - dedication to public service, empathy, tolerance",
        "Emotional Intelligence - concepts and utility in administration",
        "Emotional intelligence and leadership",
        # 4.2.1 Ethical Dilemmas & Accountability
        "Ethical concerns and dilemmas in government and private institutions",
        "Laws, rules, regulations, and conscience as sources of ethical guidance",
        "Strengthening ethical values in governance and international relations",
        # 4.2.2 Probity and Anti-Corruption Measures
        "Concept of public service - philosophical basis of governance",
        "Information sharing and transparency - Right to Information",
        "Codes of Conduct vs Codes of Ethics",
        "Citizen's Charters, work culture, and quality of service delivery",
        "Corruption - Prevention of Corruption Act and institutional bottlenecks",
        "Whistleblower protection and institutional pushback",
        "Conflict of interest in public administration",
        # 4.3.1 Administrative Case Studies
        "Case studies - conflict of interest (personal relationships vs public duty)",
        "Crisis management scenarios - law and order, industrial disasters",
        "Crisis management - relief distribution ethics",
        "Whistleblowing - moral choices and institutional protection",
        "Development vs Environment disputes - tribal displacement",
